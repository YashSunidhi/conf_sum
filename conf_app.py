...
def main_page():
    ...
    cola.markdown("<h6 style='text-align: center; color: grey;'> Reference Post with Positive Sentiments </h6>", unsafe_allow_html=True)
    cola.write(do3_1)
    colb.markdown("<h6 style='text-align: center; color: grey;'> Reference Post with Negative Sentiments </h6>", unsafe_allow_html=True)
    colb.write(do3_2)
    colc.markdown("<h6 style='text-align: center; color: grey;'> Reference Post with Neutral Sentiments </h6>", unsafe_allow_html=True)
    colc.write(do3_3)
