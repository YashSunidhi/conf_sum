...
if uploaded_file is not None:
    if uploaded_file1 is not None:
        ...
        def main_page(uploaded_file = uploaded_file,uploaded_file1 = uploaded_file1):
            ...
            do3 = df1[(df1['CustomName']==concept_option)]['Represented Document'].reset_index(drop=True).to_list()
            do4 = ', '.join(df1[(df1['CustomName']==concept_option)]['Keywords_u'].reset_index(drop=True).to_list())
